"""
update_download_docx.py
Inserts Smart Trimming into C:\\Users\\nicit\\Downloads\\WILD_MECHANICS_PRODUCTION_PIPELINE2.docx
"""
...
add_heading("C. Smart Trimming (AI Sentence Boundaries)", level=2)
add_bullet("Smart Trimming:", "Uses Whisper word-level timestamps to automatically detect natural punctuation periods and speech pauses, guaranteeing clips end on a completed thought (55s–58s for BBC / 70s–85s for Non-BBC) with zero mid-sentence cuts.")
...
add_bullet("Voiceover Script:", "Punchy closing biological superpower statement + channel follow invite: 'Nature is full of hidden biological superpowers, just like this one. Follow Wild Mechanics for more.', etc.")
...
print(f"✅ Successfully updated: {target_file} ({target_file.stat().st_size / 1024:.1f} KB)")
