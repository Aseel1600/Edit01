...
from lib.subtitles.domain import (
    RenderScene, StylePreset, Canvas, Caption
)
from lib.subtitles.alignment import WhisperAlignmentProvider, WhisperXAlignmentProvider
from lib.subtitles.transcript_resolver import TranscriptResolver
from lib.subtitles.caption_segmenter import CaptionSegmenter
from lib.subtitles.layout_engine import LayoutEngine
from lib.subtitles.ass_renderer import ASSRenderer
from lib.subtitles.emoji_engine import EmojiEngine
from lib.subtitles.speaker_manager import SpeakerManager
from lib.subtitles.quality_analyzer import QualityAnalyzer
from lib.subtitles.cache import SubtitleCache
from lib.subtitles.svg_renderer import SVGRenderer
...
class SubtitleProcessor:
    ...
    def build_render_scene_from_fragments(
        ...
        from lib.subtitles.domain import TimedWord, Canvas, RenderScene
    ...
    def _burn_with_moviepy(self, input_video_path: pathlib.Path, output_video_path: pathlib.Path, scene: RenderScene):
        ...
        from lib.subtitles.font_manager import FontManager
